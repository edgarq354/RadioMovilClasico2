...
public class Qr_verificar_conductor extends AppCompatActivity implements me.dm7.barcodescanner.zxing.ZXingScannerView.ResultHandler {
    ...
    public void handleResult(Result rawResult) {
        ...
        try {
            ...
            hilo.execute(getString(R.string.servidor) + "frmTaxi.php?opcion=verificar_conductor_qr", "1",id_conductor);// parametro que recibe el doinbackground
        }catch (Exception e)
        {
    ...
    public class Servicio extends AsyncTask<String,Integer,String> {
        ...
        protected void onPreExecute() {
            ...
            try {
                pDialog = new ProgressDialog(Qr_verificar_conductor.this);
