...
import com.elisoft.radiomovilclasico.compartir.UsuarioAdapter;
...
public class Panico_principal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_panico_principal);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(),Buscar_usuario_panico.class));
            }
        });
...
// Crear un nuevo adaptador
    ...
    protected void onStart() {
        ...
        hilo_pedido.execute(ip+"frmCompartir_carrera.php?opcion=lista_de_usuarios_compartir_panico", "1",id);// parametro que recibe el doinbackground
    ...
    public void cargar_usuarios() {
        ...
        Cursor fila = bd.rawQuery("select id,nombre,apellido,correo,celular from usuario_panico  ORDER BY nombre ASC ", null);
    ...
    public void aliminar_compatimiento(final int id_usuario_compartir)
    {
        ...
        dialogo1.setMessage("¿Desea eliminar de tus contactos de Panicoo?");
    ...
    public class Servicio_compartir extends AsyncTask<String,Integer,String> {
        ...
        protected void onPreExecute() {
            ...
            try {
                pDialog = new ProgressDialog(Panico_principal.this);
    ...
    private void insertar_usuarios(String id, String nombre, String apellido, String correo, String celular) {
        ...
        try {
            ...
            bd.insert("usuario_panico", null, registro);
            bd.close();
        }catch (Exception e)
        {
            e.printStackTrace();
